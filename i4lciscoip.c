...
/*
 * Function: DecodeI4LCiscoIPPkt(struct pcap_pkthdr*, u_int8_t*)
 *
 * Purpose: Decodes packets coming in raw on layer 2, like PPP.
 *
 * Arguments:
 ...
 */
void DecodeI4LCiscoIPPkt(struct pcap_pkthdr *pkthdr, u_int8_t *pkt)
{
    ...
    if (dump_link_layer) { 
      ...
      printf( "I4LCiscoIP Packet!\n");
    }

    DecodeIP(pkt + 4, pkthdr->caplen - 4);
