...
pkgdatadir = $(datadir)/snif
pkglibdir = $(libdir)/snif
...
CONFIG_CLEAN_FILES =
sbin_PROGRAMS = snif$(EXEEXT)
PROGRAMS = $(sbin_PROGRAMS)

am_snif_OBJECTS = snif.$(OBJEXT) ethernet.$(OBJEXT) tokenring.$(OBJEXT) \
	fddi.$(OBJEXT) llc.$(OBJEXT) snap.$(OBJEXT) enc.$(OBJEXT) \
	ppp.$(OBJEXT) pppserial.$(OBJEXT) slip.$(OBJEXT) wifi.$(OBJEXT) \
	chdlc.$(OBJEXT) sll.$(OBJEXT) pflog.$(OBJEXT) \
	oldpflog.$(OBJEXT) eap.$(OBJEXT) pppoe.$(OBJEXT) \
	loopback.$(OBJEXT) raw.$(OBJEXT) i4lrawip.$(OBJEXT) \
	i4lciscoip.$(OBJEXT) vlan.$(OBJEXT) arp.$(OBJEXT) ip.$(OBJEXT) \
	ipv6.$(OBJEXT) ipx.$(OBJEXT) ethlb.$(OBJEXT) icmp.$(OBJEXT) \
	tcp.$(OBJEXT) udp.$(OBJEXT) gre.$(OBJEXT)
snif_OBJECTS = $(am_snif_OBJECTS)
snif_DEPENDENCIES = sfutil/libsfutil.a
snif_LDFLAGS =
...
DEP_FILES = ./$(DEPDIR)/arp.Po ./$(DEPDIR)/chdlc.Po \
	./$(DEPDIR)/eap.Po ./$(DEPDIR)/enc.Po \
	./$(DEPDIR)/ethernet.Po ./$(DEPDIR)/ethlb.Po \
	./$(DEPDIR)/fddi.Po ./$(DEPDIR)/gre.Po \
	./$(DEPDIR)/i4lciscoip.Po ./$(DEPDIR)/i4lrawip.Po \
	./$(DEPDIR)/icmp.Po ./$(DEPDIR)/ip.Po \
	./$(DEPDIR)/ipv6.Po ./$(DEPDIR)/ipx.Po \
	./$(DEPDIR)/llc.Po ./$(DEPDIR)/loopback.Po \
	./$(DEPDIR)/oldpflog.Po ./$(DEPDIR)/pflog.Po \
	./$(DEPDIR)/ppp.Po ./$(DEPDIR)/pppoe.Po \
	./$(DEPDIR)/pppserial.Po ./$(DEPDIR)/raw.Po \
	./$(DEPDIR)/slip.Po ./$(DEPDIR)/sll.Po \
	./$(DEPDIR)/snap.Po ./$(DEPDIR)/snif.Po \
	./$(DEPDIR)/tcp.Po ./$(DEPDIR)/tokenring.Po \
	./$(DEPDIR)/udp.Po ./$(DEPDIR)/vlan.Po \
	./$(DEPDIR)/wifi.Po
...
snif$(EXEEXT): $(snif_OBJECTS) $(snif_DEPENDENCIES) 
	@rm -f snif$(EXEEXT)
	$(LINK) $(snif_LDFLAGS) $(snif_OBJECTS) $(snif_LDADD) $(LIBS)
...
include ./$(DEPDIR)/chdlc.Po
include ./$(DEPDIR)/eap.Po
include ./$(DEPDIR)/enc.Po
include ./$(DEPDIR)/ethernet.Po
include ./$(DEPDIR)/ethlb.Po
include ./$(DEPDIR)/fddi.Po
include ./$(DEPDIR)/gre.Po
include ./$(DEPDIR)/i4lciscoip.Po
include ./$(DEPDIR)/i4lrawip.Po
...
include ./$(DEPDIR)/oldpflog.Po
include ./$(DEPDIR)/pflog.Po
include ./$(DEPDIR)/ppp.Po
include ./$(DEPDIR)/pppoe.Po
include ./$(DEPDIR)/pppserial.Po
include ./$(DEPDIR)/raw.Po
include ./$(DEPDIR)/slip.Po
include ./$(DEPDIR)/sll.Po
include ./$(DEPDIR)/snap.Po
include ./$(DEPDIR)/snif.Po
include ./$(DEPDIR)/tcp.Po
include ./$(DEPDIR)/tokenring.Po
include ./$(DEPDIR)/udp.Po
include ./$(DEPDIR)/vlan.Po
include ./$(DEPDIR)/wifi.Po
...
installdirs-am:
	$(mkinstalldirs) $(DESTDIR)$(sbindir) $(DESTDIR)$(datadir)
